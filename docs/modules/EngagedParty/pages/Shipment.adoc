...
$ref of: xref:v4.2@schemas:EngagedParty:ShippingInstruction.adoc[]
...
$ref of: xref:v4.2@schemas:EngagedParty:ShipmentTrackingRef.adoc[]


=== placeFrom
description: Source location of the package. E.g. warehouse or shop location

$ref of: xref:v4.2@schemas:EngagedParty:RelatedPlaceRefOrValue.adoc[]
...
$ref of: xref:v4.2@schemas:EngagedParty:RelatedShipment.adoc[]
...
$ref of: xref:v4.2@schemas:EngagedParty:PaymentMethodRef.adoc[]
...
$ref of: xref:v4.2@schemas:EngagedParty:ShipmentSpecificationRefOrValue.adoc[]
