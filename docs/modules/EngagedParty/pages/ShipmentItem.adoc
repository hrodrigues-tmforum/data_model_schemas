...
$ref of: xref:v4.0@schemas:EngagedParty:ShipmentItemActionType.adoc[]
...
$ref of: xref:v4.0@schemas:EngagedParty:ReserveProductStockRef.adoc[]


=== productStockRef
$ref of: xref:v4.0@schemas:EngagedParty:ProductStockRef.adoc[]
...
$ref of: xref:v4.0@schemas:EngagedParty:ProductRefOrValue.adoc[]
