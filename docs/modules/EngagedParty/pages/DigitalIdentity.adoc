...
$ref of: xref:v4.1@schemas:EngagedParty:PartyRef.adoc[]
...
$ref of: xref:v4.1@schemas:EngagedParty:ResourceRef.adoc[]
...
This schema extends: xref:v4.1@schemas:EngagedParty:Addressable.adoc[]
