...
$ref of: xref:v4.0@schemas:EngagedParty:PartyRef.adoc[]
...
$ref of: xref:v4.0@schemas:EngagedParty:ResourceRef.adoc[]


= All Of 
This schema extends: xref:v4.0@schemas:EngagedParty:Entity.adoc[]
This schema extends: xref:v4.0@schemas:EngagedParty:Addressable.adoc[]
