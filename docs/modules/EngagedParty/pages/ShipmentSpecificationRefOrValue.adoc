...
This schema extends: xref:v4.1@schemas:EngagedParty:ShipmentSpecification.adoc[]
This schema extends: xref:v4.1@schemas:EngagedParty:ShipmentSpecificationRef.adoc[]
