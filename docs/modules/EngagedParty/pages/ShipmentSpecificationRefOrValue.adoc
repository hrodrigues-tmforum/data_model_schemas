...
= All Of 
This schema extends: xref:v4.2@schemas:EngagedParty:ShipmentSpecification.adoc[]
This schema extends: xref:v4.2@schemas:EngagedParty:ShipmentSpecificationRef.adoc[]
