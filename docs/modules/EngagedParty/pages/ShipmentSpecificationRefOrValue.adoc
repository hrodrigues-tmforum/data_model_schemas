...
= All Of 
This schema extends: xref:4.0.0@schemas:EngagedParty:ShipmentSpecification.adoc[]
This schema extends: xref:4.0.0@schemas:EngagedParty:ShipmentSpecificationRef.adoc[]
