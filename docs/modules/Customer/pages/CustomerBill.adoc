...
=== billCycle
$ref of: xref:v4.0@schemas:Customer:BillCycleRef.adoc[]
...
=== financialAccount
$ref of: xref:v4.0@schemas:Customer:FinancialAccountRef.adoc[]
...
$ref of: xref:v4.0@schemas:Customer:PaymentMethodRef.adoc[]
...
$ref of: xref:v4.0@schemas:Customer:CustomerBillRunType.adoc[]
...
$ref of: xref:v4.0@schemas:Customer:CustomerBillStateType.adoc[]
