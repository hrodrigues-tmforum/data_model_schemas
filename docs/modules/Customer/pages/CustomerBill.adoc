...
=== billCycle
$ref of: xref:v4.2@schemas:Customer:BillCycleRef.adoc[]
...
=== financialAccount
$ref of: xref:v4.2@schemas:Customer:FinancialAccountRef.adoc[]
...
$ref of: xref:v4.2@schemas:Customer:CustomerBillRunType.adoc[]
...
$ref of: xref:v4.2@schemas:Customer:CustomerBillStateType.adoc[]
