...
=== billCycle
$ref of: xref:v4.1@schemas:Customer:BillCycleRef.adoc[]
...
$ref of: xref:v4.1@schemas:Customer:CustomerBillRunType.adoc[]
...
$ref of: xref:v4.1@schemas:Customer:CustomerBillStateType.adoc[]
