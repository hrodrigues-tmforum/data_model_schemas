...
$ref of: xref:v4.1@schemas:Customer:CalendarEventRef.adoc[]
...
$ref of: xref:v4.1@schemas:Customer:RelatedPlaceRefOrValue.adoc[]
...
=== status
$ref of: xref:v4.1@schemas:Customer:AppointmentStateType.adoc[]
