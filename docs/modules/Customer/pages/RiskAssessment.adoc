...
$ref of: xref:v4.0@schemas:Customer:RelatedPlace.adoc[]
...
$ref of: xref:v4.0@schemas:Customer:RiskAssessmentResult.adoc[]


[#all_of]
== All Of

This schema extends: xref:v4.0@schemas:Customer:Addressable.adoc[]
This schema extends: xref:v4.0@schemas:Customer:Extensible.adoc[]
