...
=== settlementMethod
$ref of: xref:v4.2@schemas:Customer:SettlementMethod.adoc[]


=== settlementNoteImage
$ref of: xref:v4.2@schemas:Customer:SettlementNoteImage.adoc[]


=== receiver
$ref of: xref:v4.2@schemas:Customer:PartyRef.adoc[]
