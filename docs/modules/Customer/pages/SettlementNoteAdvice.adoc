...
=== settlementMethod
$ref of: xref:v4.1@schemas:Customer:SettlementMethod.adoc[]


=== settlementNoteImage
$ref of: xref:v4.1@schemas:Customer:SettlementNoteImage.adoc[]


=== receiver
$ref of: xref:v4.1@schemas:Customer:PartyRef.adoc[]
