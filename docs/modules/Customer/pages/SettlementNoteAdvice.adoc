...
=== settlementMethod
$ref of: xref:4.0.0@schemas:Customer:SettlementMethod.adoc[]


=== settlementNoteImage
$ref of: xref:4.0.0@schemas:Customer:SettlementNoteImage.adoc[]


=== receiver
$ref of: xref:4.0.0@schemas:Customer:PartyRef.adoc[]
