...
$ref of: xref:v4.0@schemas:Product:SLARef.adoc[]
...
$ref of: xref:v4.0@schemas:Product:ServiceCandidateRef.adoc[]
...
$ref of: xref:v4.0@schemas:Product:ResourceCandidateRef.adoc[]
...
= All Of 
This schema extends: xref:v4.0@schemas:Product:Addressable.adoc[]
