...
$ref of: xref:v4.2@schemas:Product:ProductOfferingPriceRef.adoc[]


=== billingAccount
$ref of: xref:v4.2@schemas:Product:BillingAccountRef.adoc[]
...
=== price
$ref of: xref:v4.2@schemas:Product:Price.adoc[]
