...
$ref of: xref:v4.2@schemas:Service:ServiceRef.adoc[]
...
$ref of: xref:v4.2@schemas:Service:ServiceTestSpecificationRef.adoc[]


= All Of 
This schema extends: xref:v4.2@schemas:Service:Extensible.adoc[]
This schema extends: xref:v4.2@schemas:Service:Addressable.adoc[]
