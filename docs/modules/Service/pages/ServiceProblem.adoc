...
$ref of: xref:v4.2@schemas:Service:RelatedEntity.adoc[]
...
$ref of: xref:v4.2@schemas:Service:ImpactPattern.adoc[]
...
$ref of: xref:v4.2@schemas:Service:RelatedParty.adoc[]
...
=== status
$ref of: xref:v4.2@schemas:Service:ServiceProblemStateType.adoc[]
