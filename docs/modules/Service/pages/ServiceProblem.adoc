...
$ref of: xref:v4.0@schemas:Service:RelatedEntity.adoc[]
...
$ref of: xref:v4.0@schemas:Service:ImpactPattern.adoc[]
...
$ref of: xref:v4.0@schemas:Service:RelatedParty.adoc[]
...
=== status
$ref of: xref:v4.0@schemas:Service:ServiceProblemStateType.adoc[]
