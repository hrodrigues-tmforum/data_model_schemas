...
$ref of: xref:v4.1@schemas:Resource:TimePeriod.adoc[]
...
$ref of: xref:v4.1@schemas:Resource:TargetResourceSchema.adoc[]
...
This schema extends: xref:v4.1@schemas:Resource:Addressable.adoc[]
