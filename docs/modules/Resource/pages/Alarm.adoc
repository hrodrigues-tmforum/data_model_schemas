...
=== alarmType
$ref of: xref:v4.0@schemas:Resource:AlarmType.adoc[]


=== perceivedSeverity
$ref of: xref:v4.0@schemas:Resource:PerceivedSeverity.adoc[]
...
=== alarmedObject
$ref of: xref:v4.0@schemas:Resource:AlarmedObject.adoc[]
...
$ref of: xref:v4.0@schemas:Resource:CrossedThresholdInformation.adoc[]
