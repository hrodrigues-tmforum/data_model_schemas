...
=== alarmType
$ref of: xref:v4.1@schemas:Resource:AlarmType.adoc[]


=== perceivedSeverity
$ref of: xref:v4.1@schemas:Resource:PerceivedSeverity.adoc[]
...
=== alarmedObject
$ref of: xref:v4.1@schemas:Resource:AlarmedObject.adoc[]
...
$ref of: xref:v4.1@schemas:Resource:CrossedThresholdInformation.adoc[]
