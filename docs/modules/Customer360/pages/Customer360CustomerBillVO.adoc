...
=== amountDue
$ref of: xref:v4.1@schemas:Customer360:Money.adoc[]
...
=== billCycle
$ref of: xref:v4.1@schemas:Customer360:BillCycleRef.adoc[]
...
$ref of: xref:v4.1@schemas:Customer360:PaymentMethodRef.adoc[]
...
$ref of: xref:v4.1@schemas:Customer360:CustomerBillRunType.adoc[]
...
$ref of: xref:v4.1@schemas:Customer360:CustomerBillStateType.adoc[]
