...
[#diagram]
== Diagram
image::Resource_ServiceProblem.png[Diagram illustrating ServiceProblem]
...
$ref of: xref:v4.0@schemas:Tmf:ImpactPattern.adoc[]
...
=== status
$ref of: xref:v4.0@schemas:Tmf:ServiceProblemStateType.adoc[]
