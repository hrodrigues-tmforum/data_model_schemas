...
[#diagram]
== Diagram
image::Resource_UsageSpecCharacteristic.png[Diagram illustrating SpecCharacteristic]

[#diagram]
== Diagram
image::Resource_SpecCharacteristic.png[Diagram illustrating SpecCharacteristic]

[#diagram]
== Diagram
image::Resource_ServiceSpecCharacteristic.png[Diagram illustrating SpecCharacteristic]

[#diagram]
== Diagram
image::Resource_AgreementSpecCharacteristic.png[Diagram illustrating SpecCharacteristic]
