...
[#diagram]
== Diagram
image::Resource_CheckWorkQualificationItem.png[Diagram illustrating CheckWorkQualificationItem]
...
This schema extends: xref:v4.0@schemas:Tmf:WorkQualificationItem.adoc[]
