...
[#diagram]
== Diagram
image::Resource_LogicalResourceSpecification.png[Diagram illustrating ResourceSpecification]
...
[#diagram]
== Diagram
image::Resource_PhysicalResourceSpecification.png[Diagram illustrating ResourceSpecification]
...
$ref of: xref:v4.0@schemas:Tmf:TargetResourceSchema.adoc[]
