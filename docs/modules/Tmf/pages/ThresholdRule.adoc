...
[#diagram]
== Diagram
image::Resource_AlgorithmThresholdRule.png[Diagram illustrating ThresholdRule]

[#diagram]
== Diagram
image::Resource_ThresholdRule.png[Diagram illustrating ThresholdRule]

[#diagram]
== Diagram
image::Resource_SimpleThresholdRule.png[Diagram illustrating ThresholdRule]

[#diagram]
== Diagram
image::Resource_MetricDefMeasureThresholdRule.png[Diagram illustrating ThresholdRule]
