...
[#diagram]
== Diagram
image::Resource_SpecCharRelationship.png[Diagram illustrating SpecCharRelationship]

[#diagram]
== Diagram
image::Resource_ServiceSpecCharRelationship.png[Diagram illustrating SpecCharRelationship]
