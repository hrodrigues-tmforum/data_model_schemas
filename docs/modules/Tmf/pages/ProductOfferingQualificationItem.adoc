...
[#diagram]
== Diagram
image::Resource_ProductOfferingQualificationItem.png[Diagram illustrating ProductOfferingQualificationItem]
...
$ref of: xref:v4.0@schemas:Tmf:ProductActionType.adoc[]
