...
[#diagram]
== Diagram
image::Resource_BankAccountTransferMethod.png[Diagram illustrating BankAccountTransferMethod]
...
=== details
$ref of: xref:v4.0@schemas:Tmf:BankAccountTransferDetails.adoc[]
