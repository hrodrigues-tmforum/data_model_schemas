...
[#diagram]
== Diagram
image::Resource_GeographicSiteRelationship.png[Diagram illustrating SiteRelationship]

[#diagram]
== Diagram
image::Resource_SiteRelationship.png[Diagram illustrating SiteRelationship]
