...
[#diagram]
== Diagram
image::Resource_CancelReservation.png[Diagram illustrating Reservation]

[#diagram]
== Diagram
image::Resource_ResourceReservation.png[Diagram illustrating Reservation]

[#diagram]
== Diagram
image::Resource_CancelResourceReservation.png[Diagram illustrating Reservation]

[#diagram]
== Diagram
image::Resource_Reservation.png[Diagram illustrating Reservation]
