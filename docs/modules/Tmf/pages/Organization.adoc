...
[#diagram]
== Diagram
image::Resource_OtherNameOrganization.png[Diagram illustrating Organization]
...
$ref of: xref:v4.0@schemas:Tmf:OrganizationStateType.adoc[]
...
$ref of: xref:v4.0@schemas:Tmf:OrganizationParentRelationship.adoc[]
