...
[#diagram]
== Diagram
image::Resource_ReservationItem.png[Diagram illustrating ReservationItem]

[#diagram]
== Diagram
image::Resource_ResourceReservationItem.png[Diagram illustrating ReservationItem]
