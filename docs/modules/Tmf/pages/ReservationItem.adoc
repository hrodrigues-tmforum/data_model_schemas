...
=== action
$ref of: xref:v4.2@schemas:Tmf:ReservationItemActionType.adoc[]


=== appliedCapacity
$ref of: xref:v4.2@schemas:Tmf:Capacity.adoc[]
...
=== state
$ref of: xref:v4.2@schemas:Tmf:ReservationItemStateType.adoc[]
