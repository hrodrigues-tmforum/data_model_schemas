...
[#diagram]
== Diagram
image::Resource_PartyRoleProductOfferingRiskAssessment.png[Diagram illustrating ProductOfferingRiskAssessment]

[#diagram]
== Diagram
image::Resource_ProductOfferingRiskAssessment.png[Diagram illustrating ProductOfferingRiskAssessment]
