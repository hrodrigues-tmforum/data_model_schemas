...
[#diagram]
== Diagram
image::Resource_AppliedPayment.png[Diagram illustrating Payment]
...
[#diagram]
== Diagram
image::Resource_AuthorizePayment.png[Diagram illustrating Payment]

[#diagram]
== Diagram
image::Resource_InitiatePayment.png[Diagram illustrating Payment]
