...
[#diagram]
== Diagram
image::Resource_GeographicLocation.png[Diagram illustrating GeographicLocation]

[#diagram]
== Diagram
image::Resource_RetrieveGeographicLocation.png[Diagram illustrating GeographicLocation]
