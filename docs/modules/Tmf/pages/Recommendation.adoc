...
[#diagram]
== Diagram
image::Resource_Recommendation.png[Diagram illustrating Recommendation]

[#diagram]
== Diagram
image::Resource_QueryProductRecommendation.png[Diagram illustrating Recommendation]
