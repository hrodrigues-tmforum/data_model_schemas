...
[#diagram]
== Diagram
image::Resource_PhysicalResource.png[Diagram illustrating Resource]

[#diagram]
== Diagram
image::Resource_LogicalResource.png[Diagram illustrating Resource]

[#diagram]
== Diagram
image::Resource_SupportingResource.png[Diagram illustrating Resource]

[#diagram]
== Diagram
image::Resource_ConcreteResource.png[Diagram illustrating Resource]
