...
[#diagram]
== Diagram
image::Resource_TopupBalance.png[Diagram illustrating TopupBalance]

[#diagram]
== Diagram
image::Resource_RelatedTopupBalance.png[Diagram illustrating TopupBalance]
...
=== relatedTopupBalance
$ref of: xref:v4.0@schemas:Tmf:RelatedTopupBalance.adoc[]
