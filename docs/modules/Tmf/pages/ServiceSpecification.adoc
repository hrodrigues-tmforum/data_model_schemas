...
[#diagram]
== Diagram
image::Resource_ServiceSpecification.png[Diagram illustrating ServiceSpecification]

[#diagram]
== Diagram
image::Resource_IotServiceSpecification.png[Diagram illustrating ServiceSpecification]
