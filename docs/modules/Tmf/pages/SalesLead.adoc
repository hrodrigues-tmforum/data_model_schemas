...
=== status
$ref of: xref:v4.1@schemas:Tmf:SalesLeadStateType.adoc[]
...
=== priority
$ref of: xref:v4.1@schemas:Tmf:SalesLeadPriorityType.adoc[]
...
$ref of: xref:v4.1@schemas:Tmf:MarketingCampaignRef.adoc[]
...
$ref of: xref:v4.1@schemas:Tmf:MarketSegmentRef.adoc[]
...
=== salesOpportunity
$ref of: xref:v4.1@schemas:Tmf:SalesOpportunityRef.adoc[]
