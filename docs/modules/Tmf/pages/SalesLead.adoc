...
=== status
$ref of: xref:4.0.0@schemas:Tmf:SalesLeadStateType.adoc[]
...
=== priority
$ref of: xref:4.0.0@schemas:Tmf:SalesLeadPriorityType.adoc[]
...
$ref of: xref:4.0.0@schemas:Tmf:MarketingCampaignRef.adoc[]
...
$ref of: xref:4.0.0@schemas:Tmf:MarketSegmentRef.adoc[]
...
=== salesOpportunity
$ref of: xref:4.0.0@schemas:Tmf:SalesOpportunityRef.adoc[]
