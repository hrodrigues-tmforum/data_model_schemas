...
[#diagram]
== Diagram
image::Resource_RelatedServiceOrderItem.png[Diagram illustrating ServiceOrderItem]

[#diagram]
== Diagram
image::Resource_ServiceOrderItem.png[Diagram illustrating ServiceOrderItem]
