...
[#diagram]
== Diagram
image::Resource_ProductSpecification.png[Diagram illustrating ProductSpecification]

[#diagram]
== Diagram
image::Resource_WarrantyProductSpecification.png[Diagram illustrating ProductSpecification]

[#diagram]
== Diagram
image::Resource_BundledProductSpecification.png[Diagram illustrating ProductSpecification]
