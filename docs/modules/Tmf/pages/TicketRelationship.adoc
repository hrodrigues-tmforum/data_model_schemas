...
[#diagram]
== Diagram
image::Resource_TicketRelationship.png[Diagram illustrating TicketRelationship]

[#diagram]
== Diagram
image::Resource_TroubleTicketRelationship.png[Diagram illustrating TicketRelationship]
