...
=== status
$ref of: xref:v4.2@schemas:MarketingSales:SalesLeadStateType.adoc[]
...
=== priority
$ref of: xref:v4.2@schemas:MarketingSales:SalesLeadPriorityType.adoc[]


=== estimatedRevenue
description: Estimation of the revenue if the salesLead turns into a sale.

$ref of: xref:v4.2@schemas:MarketingSales:Money.adoc[]


=== validFor
description: The period for which the salesLead is valid

$ref of: xref:v4.2@schemas:MarketingSales:TimePeriod.adoc[]
...
$ref of: xref:v4.2@schemas:MarketingSales:MarketingCampaignRef.adoc[]
...
$ref of: xref:v4.2@schemas:MarketingSales:MarketSegmentRef.adoc[]


=== channel
$ref of: xref:v4.2@schemas:MarketingSales:ChannelRef.adoc[]


=== productOffering
$ref of: xref:v4.2@schemas:MarketingSales:ProductOfferingRef.adoc[]
...
$ref of: xref:v4.2@schemas:MarketingSales:ProductSpecificationRef.adoc[]


=== category
$ref of: xref:v4.2@schemas:MarketingSales:CategoryRef.adoc[]


=== salesOpportunity
$ref of: xref:v4.2@schemas:MarketingSales:SalesOpportunityRef.adoc[]


=== product
$ref of: xref:v4.2@schemas:MarketingSales:ProductRef.adoc[]
...
This schema extends: xref:v4.2@schemas:MarketingSales:Entity.adoc[]
