...
=== action
$ref of: xref:v4.1@schemas:Common:ReservationItemActionType.adoc[]


=== appliedCapacity
$ref of: xref:v4.1@schemas:Common:Capacity.adoc[]
...
=== state
$ref of: xref:v4.1@schemas:Common:ReservationItemStateType.adoc[]
