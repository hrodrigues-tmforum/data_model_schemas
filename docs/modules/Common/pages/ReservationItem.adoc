...
=== action
$ref of: xref:v4.2@schemas:Common:ReservationItemActionType.adoc[]


=== appliedCapacity
$ref of: xref:v4.2@schemas:Common:Capacity.adoc[]
...
=== state
$ref of: xref:v4.2@schemas:Common:ReservationItemStateType.adoc[]
