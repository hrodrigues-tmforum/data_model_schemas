...
$ref of: xref:4.0.0@schemas:Common:Uri.adoc[]
...
=== budget
$ref of: xref:4.0.0@schemas:Common:Money.adoc[]
...
$ref of: xref:4.0.0@schemas:Common:RelatedPlaceRefOrValue.adoc[]
...
=== status
$ref of: xref:4.0.0@schemas:Common:ChangeRequestStatusType.adoc[]
