...
=== workLog
$ref of: xref:v4.1@schemas:Common:WorkLog.adoc[]
...
$ref of: xref:v4.1@schemas:Common:ChangeRequestSpecification.adoc[]
...
=== resolution
$ref of: xref:v4.1@schemas:Common:Resolution.adoc[]
...
$ref of: xref:v4.1@schemas:Common:GeographicAddressRef.adoc[]
